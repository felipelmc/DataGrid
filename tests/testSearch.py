    ...
    for i in n:
        ...
        for column in columns:
            if column == 'id':
                ...
                print(f"Mean time to search {i} rows by {column}: {mean_time}")
                ...
                for owner_id in owner_ids:
                    ...
                    datagrid.search(column, owner_id)
                ...
                for creation_date in creation_dates:
                    ...
                    datagrid.search(column, creation_date)
                ...
                for content in contents:
                    ...
                    datagrid.search(column, content)
